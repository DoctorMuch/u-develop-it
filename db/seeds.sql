...
VALUES
  ...
  VALUES
    ...
    ('Antoinette', 'Capet', 'acapet@dontloseyourtete.com'),
    ('Samuel', 'Delany', 'sdelany@dhalgren.edu'),
    ('Tony', 'Duvert', 'tduverty@frenchletters.edu'),
    ('Dennis', 'Cooper', 'dcooper@gerogemiles.com'),
